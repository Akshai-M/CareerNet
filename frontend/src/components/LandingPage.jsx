...
export default function BackgroundLinesDemo() {
  ...
  return (
    <BackgroundLines className="dark:bg-black bg-white relative flex items-center justify-center w-full flex-col px-4">
      ...
      <p className=""></p>
      <h2 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-300 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
