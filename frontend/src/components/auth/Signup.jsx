...
import { faLock, faEnvelope, faPhone, faFont } from "@fortawesome/free-solid-svg-icons";
...
const Signup = () => {
  ...
  return (<div className="flex items-center justify-center mt-14">
    <form
      ...
      className="form-container rounded-md"
    >
      <h1 className="font-extrabold text-4xl mb-5 text-blue-600 text-center">Sign Up</h1>
      ...
      <div className="profile-picture-container">
        <label className="cursor-pointer">
          {previewImage ? (
            ...
            <BsPersonCircle size={120} className="text-white" />
          )}
          <input
            type="file"
            accept="image/*"
      ...
      <div className="my-2">
        <div className="divinput">
          <FontAwesomeIcon icon={faFont} className="text-gray-500 ml-2 mr-4" />
          <input
            type="text"
      ...
      <div className="my-2">
        <div className="divinput">
          <FontAwesomeIcon icon={faPhone} className="text-gray-500 ml-2 mr-4" />
          <input
            type="text"
      ...
      <p className="mt-3 text-center textcolor text-sm">
